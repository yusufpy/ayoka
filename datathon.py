...
parent_education_level = st.selectbox('Parent Education Level', ['High School', 'Bachelor', 'Master', 'PhD'])
family_structure = st.selectbox('Family Structure', ['Nuclear', 'Single Parent', 'Extended'])
transport_mode = st.selectbox('Transport Mode', ['Walking', 'Public Transport', 'Private Vehicle'])
qualification = st.selectbox('Qualification (for teachers)', ['Bachelor', 'Master', 'PhD'])
boarding_status = st.selectbox('Boarding Status', ['Day Scholar', 'Boarder'])
